package com.company;/* Generated By:JavaCC: Do not edit this line. PHP.java */
import java.util.*;
...
public  class PHP implements PHPConstants {
        ...
        private static void showMetrics(){
            System.out.println("\u005cn\u005cn*********Program Metrics*********\u005cn");
            System.out.println("Lines Of Code (LOC): " + linesOfCode + "\u005cn");
            System.out.println("Number of Methods (NOM): " + nom + "\u005cn");
            System.out.println("Number of multi-lined comments " + PHPTokenManager.comMultiLined + "\u005cn");
            System.out.println("Number of single-lined comments " + PHPTokenManager.comSingleLined + "\u005cn");
        }
