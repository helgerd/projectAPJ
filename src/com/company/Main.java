...
public class Main {
    ...
    public final static List<String> metricNames = new ArrayList<>(Arrays.asList(
            ...
            "Number Of Public Class Attributes",
            "Class Size",
    ...
    public double [] run(File file) {
        ...
        try {
            ...
            if(parser != null)parser.ReInit(new FileInputStream(file));
            else parser = new PHP(new FileInputStream(file));
    ...
    public void saveMetrics(BufferedWriter writer){
